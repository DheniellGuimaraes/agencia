	...
	public static function render() {
		...
		<div class="sap-wrap">
			...
			<div class="sap-grid">
				...
				</div><label class="sap-url-label">URL principal</label><div class="sap-url-row"><input id="sap-main-url" readonly value="<?php echo esc_url( SAP_Files::main_url() ); ?>"></div><p class="sap-path">Pasta: <?php echo esc_html( $diag['directory'] ); ?></p></section>
				...
				<section class="sap-card sap-action"><h2>Centro de controle</h2><button type="button" id="sap-generate" class="sap-btn sap-primary sap-fodao"><span class="dashicons dashicons-superhero"></span> sitemap Fodão</button><p class="sap-action-note">Um clique: verifica permissões, limpa se configurado, rastreia os conteúdos selecionados, gera os XML físicos, cria o índice e abre o download do <code>sitemap.xml</code>.</p></section>
