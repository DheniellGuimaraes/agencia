			...
			vc_map(array(
				...
				'params' => array(
					array(
						...
						'description' => sprintf(
							wp_kses(
								__('You can manage the widgets on the <a href="%1$s" target="_blank" rel="noopener noreferrer">plugin\'s settings page</a>.', $this->textDomain),
								array(
									'a' => array(
										'href' => array(),
										'target' => array(),
							...
							esc_url(admin_url('admin.php?page=' . $this->slug))
						)
					)
				)
			));
