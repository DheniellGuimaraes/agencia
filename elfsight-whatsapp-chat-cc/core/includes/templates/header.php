...
?><header class="elfsight-admin-header">
    ...
    <div class="elfsight-admin-header-main">
        <div class="elfsight-admin-header-main-title"><?php echo esc_html($dashboard_brand_name); ?></div>

        <a class="elfsight-admin-header-main-logo" href="<?php echo admin_url('admin.php?page=' . $this->slug); ?>" title="<?php echo esc_html($dashboard_brand_name); ?>">
            <img src="<?php echo plugins_url('assets/img/logo.svg', $this->pluginFile); ?>" width="48" height="48" alt="<?php echo esc_html($dashboard_brand_name); ?>">
        </a>
