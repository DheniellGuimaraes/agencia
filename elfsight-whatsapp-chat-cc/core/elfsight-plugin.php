...
if (!class_exists('ElfsightWhatsappChatPlugin')) {
    class ElfsightWhatsappChatPlugin {
        ...
        public function formatAtts($atts) {
            ...
            $dashes_to_camel_case = static function ($string) {
                return preg_replace_callback('/[_-][a-zA-Z]/', static function ($matches) {
                    return strtoupper($matches[0][1]);
                }, $string);
            };

            foreach ($atts as $key => $value) {
                $atts[$dashes_to_camel_case($key)] = $value;
            }
        ...
        public function addPluginActionLinks($links) {
            ...
            $links[] = '<a href="https://codecanyon.net/user/elfsight/portfolio?ref=Elfsight" target="_blank" rel="noopener noreferrer">More plugins by Elfsight</a>';
